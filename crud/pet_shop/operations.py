...
def venda_produtos():
    acumulador_1 = 0
    while True:
        op_produto = input("Escolha o produto desejado (ou digite 'sair' para finalizar): ")
        ...
        acumulador_1 += valor
        print(f"Produto adicionado! Valor total acumulado da compra até agora: R$ {acumulador_1:.2f}\n")
